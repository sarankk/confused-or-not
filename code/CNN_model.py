...
class cnn_model(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv1d(Samples, 32, kernel_size=2, stride=2, padding=1),
            nn.BatchNorm1d(32),
            nn.ReLU())
        self.layer2 = nn.Sequential(
            nn.Conv1d(32, 16, kernel_size=2, stride=2, padding=1),
            nn.BatchNorm1d(16),
            nn.ReLU())
        self.layer3 = nn.Sequential(
            nn.Conv1d(16, 8, kernel_size=2, stride=2, padding=1),
            nn.BatchNorm1d(8),
            nn.ReLU())
        self.fc1 = nn.Linear(8*3, 32)
